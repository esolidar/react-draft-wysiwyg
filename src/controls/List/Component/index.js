    ...
    return (
      ...
      >
        {options.indexOf("unordered") >= 0 && (
          ...
          >
            {typeof unordered.icon !== "string" ? (
              unordered.icon
            ) : (
              <img alt="" src={unordered.icon} />
            )}
          </Option>
        )}
        {options.indexOf("ordered") >= 0 && (
          ...
          >
            {typeof ordered.icon !== "string" ? (
              ordered.icon
            ) : (
              <img alt="" src={ordered.icon} />
            )}
          </Option>
        )}
        {options.indexOf("indent") >= 0 && (
          ...
          >
            {typeof indent.icon !== "string" ? (
              indent.icon
            ) : (
              <img alt="" src={indent.icon} />
            )}
          </Option>
        )}
        {options.indexOf("outdent") >= 0 && (
          ...
          >
            {typeof outdent.icon !== "string" ? (
              outdent.icon
            ) : (
              <img alt="" src={outdent.icon} />
            )}
          </Option>
        )}
      </div>

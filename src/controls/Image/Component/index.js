      ...
      >
        ...
        {altConf.present && (
          <div className="rdw-image-modal-size">
            <span className="rdw-image-modal-alt-lbl">
              {translations["components.controls.image.altText"]}
            </span>
            <input
              onChange={this.updateValue}
              onBlur={this.updateValue}
              ...
              placeholder={
                translations["components.controls.image.altPlaceholder"]
              }
            />
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          {typeof icon !== "string" ? icon : <img alt="" src={icon} />}
        </Option>
